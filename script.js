...
function getCheeringTicker(battleId) {
  const battleNames = {
    battlefield01: "감란의병 전투 : 임진년(1592) ~ 정유년(1597)까지 척제공 장몽기 의병장이 감란일기를 통하여 경상도 지역에서 벌어진 의병 항쟁을 벌이신 감란의변 전투이다. ",
    ...
    battlefield05: "화원일대 전투(1592.08.19.) : 장공은 수백명의 병사들을 수정동, 법교동에 매복시키고, 참대롱과 횃불로 일제히 적군을 향해 돌격하여 적을 강물에 떨어지게 하여 큰 승리로 이끈 전투이다.  ",
    battlefield06: "모량천-당현 전투(1592.08.25~26.) : 조성, 백상대와 함께 세갈래 횃불을 만들고, 왜장 가등청정이 진격해오자 매복한 병사들이 활과 화공으로 공격하여 수많은 왜군을 참수한 전투이다.  ",
    ...
    battlefield10: "화왕산성 전투(1597.08.18.) : 의병군들은 화왕산에 진을 치고 왜군 가등청정의 대규모 병력이 쳐들어오자 곽재우, 최동보, 손처약 등 붉은 옷을 입고 적군을 혼란시키며 방어하여 북상 진격을 크게 저지한 전투이다. ",
    battlefield11: "달성 전투(1597.08.29.) : 왜군이 팔공산성에 접근하자 관찰사 이용순, 병마사 김응서와 함께 장몽기, 권응수, 최동보 병력 1000여명이 모여 여러차례 격전을 벌였고, 6일간 8차례 교전에서 큰 승리를 이끈 전투이다. ",
